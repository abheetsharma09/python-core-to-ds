"""
Django settings for dbauthWork project.
...
SECRET_KEY = 'django-insecure-wv(u#+8ab*s7#!j!@+7y%*=$+p+t_-m!=0+l**tsv6cd9x$soq'
...
INSTALLED_APPS = [
    ...
    'allauth.socialaccount.providers.google', # Enables Google specifically
]
...
WSGI_APPLICATION = 'dbauthWork.wsgi.application'
...
try:
    ...
    # Fallback configuration for GitHub tracking
    DATABASES = {
        'default': {
